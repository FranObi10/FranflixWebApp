<!-- /**
This script displays the user dashboard page. It retrieves user information from the database and displays it on the
page. 
                        ...
                        <div class="card h-100">
                            <div class="card-body">
                                <h6 class="d-flex align-items-center mb-3"><i
                                        class="material-icons text-info mr-2">Favorite</i>Movies</h6>
                                <?php
                ...
                ?>
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="card h-100">
                            <div class="card-body">
                                <h6 class="d-flex align-items-center mb-3"><i
                                        class="material-icons text-info mr-2">Favorite</i>TV Shows</h6>
                                <?php
